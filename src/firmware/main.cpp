...
void loop() {
  static const Command commands[] = {
    ...
    // bitmap.cpp
    { F("SCR"), DoIdle<init_SCR> },
    { F("notalkface"), DoIdle<init_notalkface> },
    { F("talkface"), DoIdle<init_talkface> },
    { F("smile"), DoIdle<init_smile> },
    { F("sad"), DoIdle<init_sad> },
